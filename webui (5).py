...
def queue_obp(model,base_model,size,aspect_ratios_selection,amountofimages,insanitylevel,subject, artist, imagetype, silentmode, workprompt, antistring, prefixprompt, suffixprompt,negative_prompt,promptcompounderlevel, seperator, givensubject,smartsubject,giventypeofimage,imagemodechance, gender, chosensubjectsubtypeobject, chosensubjectsubtypehumanoid, chosensubjectsubtypeconcept, promptvariantinsanitylevel, givenoutfit, autonegativeprompt, autonegativepromptstrength, autonegativepromptenhance, base_model_obp, OBP_preset, amountoffluff, promptenhancer, presetprefix, presetsuffix):
    ...
    negative_gen='negative_gen'

    for generation in range(prompts):
...
#                                        increasestability = gr.Checkbox(label="Increase stability", value=False)
                            with gr.Row(variant="compact"):
                                    with gr.Accordion("help", open=False):
                                        gr.Markdown(ob_prompt.ob_run2) 
                            with gr.Row(variant="compact"):
                                with gr.Column(variant="compact"):
                                    amountofimages = gr.Slider(1, 50, value="20", step=1, label="Amount of images to generate",interactive=True)
                                    size = gr.Dropdown(ob_prompt.sizelist, label="Size to generate", value="all",interactive=True)
#                                    basesize = gr.Dropdown(
#                                        choices=ob_prompt.basesizelist, label="base size", value="512",interactive=True)
#                                    with gr.Row(variant="compact"):
#                                        samplingsteps = gr.Slider(1, 100, value="20", step=1, label="Sampling steps",interactive=True)
#                                        cfg = gr.Slider(1,20, value="6.0", step=0.1, label="CFG",interactive=True)
#                                    with gr.Row(variant="compact"):                              
#                                        hiresfix = gr.Checkbox(label="hires. fix", value=True,interactive=True)
#                                        hiressteps = gr.Slider(0, 100, value = "0", step=1, label="Hires steps",interactive=True)
#                                        hiresscale = gr.Slider(1, 4, value = "2", step=0.05, label="Scale",interactive=True)
#                                        denoisestrength = gr.Slider(0, 1, value="0.60", step=0.01, label="Denoise strength",interactive=True)
                                with gr.Column(variant="compact"):
...
#                                            choices=ob_prompt.samplerlist, label= "Sampler", value="all",interactive=True)
#                                        upscaler = gr.Dropdown(
#                                            choices=ob_prompt.upscalerlist, label="hires upscaler", value="all",interactive=True)
#                            with gr.Row(variant="compact"):
#                                gr.Markdown("### Quality Gate")
#                            with gr.Row(variant="compact"):
#                                with gr.Accordion("quality gate help", open=False):
#                                    gr.Markdown(ob_prompt.ob_run3)    
#                            with gr.Row(variant="compact"):
...
#                                        ob_prompt.qualitymodelist, label= "Mode of operation", value="highest", visible = False)
#                                    qualitykeep = gr.Dropdown(
#                                        ob_prompt.qualitykeeplist, label= "Images", value="keep used", visible = False)
#                            with gr.Row(variant="compact"):
#                                    gr.Markdown("### IMG2IMG upscale")
#                            with gr.Row(variant="compact"):
...
#                                            ob_prompt.modellist, label="img2img model to use", value="currently selected model")
#                                        img2imgsamplingmethod = gr.Dropdown(
#                                            ob_prompt.img2imgsamplerlist, label= "img2img sampler", value="all")   
#                                        img2imgupscaler = gr.Dropdown(
#                                            ob_prompt.img2imgupscalerlist, label="img2img upscaler", value="all")
#                                    with gr.Row(variant="compact"):
...
#                                    gr.Markdown('<font size="2">This requires the Ultimate SD Upscale extension, install this if you have not</font>')
#                            with gr.Row(variant="compact"):
...
#                                            ob_prompt.redraw_modes, label="Type", value="Linear", visible = False)
#                                    with gr.Column(scale = 1):
#                                        usduSeamsfix = gr.Dropdown(
#                                            ob_prompt.seams_fix_types, label="Seams fix", value="None", visible = False)
...
#                                                ob_prompt.img2imgupscalerlist, label="upscaler 1", value="all", visible = False)
#                                            extrasupscaler2 = gr.Dropdown(
#                                                ob_prompt.img2imgupscalerlist, label="upscaler 2", value="all", visible = False)
...
#            .then(fn=lambda: None, _js='playNotification').then(fn=lambda: None, _js='refresh_grid_delayed')
        ...
        start_obp.click(queue_obp,inputs=[model,base_model,size,aspect_ratios_selection,amountofimages,insanitylevel,subject, artist, imagetype, silentmode, workprompt, antistring, prefixprompt, suffixprompt,negative_prompt,promptcompounderlevel, seperator, givensubject,smartsubject,giventypeofimage,imagemodechance, chosengender, chosensubjectsubtypeobject, chosensubjectsubtypehumanoid, chosensubjectsubtypeconcept, promptvariantinsanitylevel, givenoutfit, autonegativeprompt, autonegativepromptstrength, autonegativepromptenhance, base_model_obp, OBP_preset, amountoffluff, promptenhancer, presetprefix, presetsuffix])
