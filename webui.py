...
#modules.flags.sdxl_aspect_ratios+=[f'512*512']
#print('--------------------------------------------',modules.flags.sdxl_aspect_ratios)
#modules.config.available_aspect_ratios = modules.config.get_config_item_or_set_default(
#    key='available_aspect_ratios',
#    default_value=modules.flags.sdxl_aspect_ratios,
#    validator=lambda x: isinstance(x, list) and all('*' in v for v in x) and len(x) > 1,
#    expected_type=list)
#print('--------------------------------------------',modules.config.available_aspect_ratios)
#modules.config.available_aspect_ratios_labels = [modules.config.add_ratio(x) for x in modules.config.available_aspect_ratios]
#print('--------------------------------------------',modules.config.available_aspect_ratios_labels)


modules.config.available_aspect_ratios_labels+=[f'512×512 <span style="color: grey;"> ∣ 1:1</span>']
ar_list=modules.config.available_aspect_ratios_labels
print (modules.config.available_aspect_ratios_labels)
...
#                    with gr.Row():
                    ...
                    def set_to_ar(width,height):
                        ...
                        ar_list[-1]=f'{width}×{height} <span style="color: grey;"> \U00002223 {width // g}:{height // g}</span>'

                        return gr.update (choices=ar_list)


                swap.click(swap_ar,inputs=[lock_ar,width_ar,height_ar],outputs=[lock_ar,width_ar,height_ar,swap])
                ...
                height_ar.release(h_slide,inputs=[lock_ar,width_ar,height_ar],outputs=[width_ar])
                set_ar.click(set_to_ar,inputs=[width_ar,height_ar],outputs=aspect_ratios_selection)
