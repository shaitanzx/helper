...
with shared.gradio_root:
    ...
    with gr.Row():
        ...
        start_obp.click(lambda: (gr.update(interactive=False),gr.update(interactive=False),gr.update(interactive=False),gr.update(visible=False),gr.update(visible=False), gr.update(visible=True, interactive=True)),
                              outputs=[batch_prompt,prompt_delete,prompt_clear,generate_button,prompt_start, prompt_stop]) \
              .then(fn=refresh_seed, inputs=[seed_random, image_seed], outputs=image_seed) \
