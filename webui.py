        ...
        with gr.Column(scale=2):
            ...
            # End of this part of presets
                        ...
                        with gr.Tab("Negative prompt"):
                            ...
                            gr.Markdown("### Base negative prompt is added on")
                            with gr.Row(): 
                        ...
                        with gr.Tab("One Button Run and Upscale"):
                            ...
                            with gr.Row(variant="compact"):
                                with gr.Column(variant="compact"):
                                    print ('aaaaaaaaaaaaaaaaaaaaaaaaa',ob_prompt.sizelist)
                                ...
                                with gr.Column(variant="compact"):
                                    ...
                                    model = gr.Dropdown(
                                        choices=ob_prompt.modellist, label="model to use", value="currently selected model",interactive=True)
                                    with gr.Column(variant="compact"):
